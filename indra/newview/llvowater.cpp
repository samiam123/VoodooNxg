...
//	LLVector3 vtx[4];
	...
	//const S32 size = (render_transparent_water && !LLGLSLShader::sNoFixedFunction) ? 16 : 1;// Org Ln but this causes water layer to flash -VS
	const S32 size = (render_transparent_water && LLGLSLShader::sNoFixedFunction) ? 16 : 1;// corrected here for now till i can find out why -VS
